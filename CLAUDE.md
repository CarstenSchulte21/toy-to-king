...
- `docs/SPEC.md` – technische Spezifikation M1/M2, `docs/SPEC-M3.md` – Ergänzungen für M3, `docs/SPEC-M3.5.md` – Sprühen 2.0, `docs/SPEC-M4a.md` – Aufstieg, `docs/SPEC-GRAFIK.md` – Raumbilder, `docs/SPEC-M4b.md` – Risiko. Bei Widersprüchen gilt die jeweils neuere SPEC.
